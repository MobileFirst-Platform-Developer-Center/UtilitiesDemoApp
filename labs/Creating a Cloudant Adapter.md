...
![Add the database](resources/database.png)
...
![Save the design document](resources/design_doc.png)
...
![Create the api key](resources/api_key.png)
...
![Input the credentials](resources/credentials.png)
...
![Test using swagger](resources/swagger.png)