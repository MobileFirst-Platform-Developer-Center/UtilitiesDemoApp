...
6. If you have problems building the app, it is always a good idea to remove and re-add the platforms. This is a known technique when dealing with hybrid apps. Simply run: `ionic platform rm ios && ionic clean && ionic platform add ios && ionic prepare`
