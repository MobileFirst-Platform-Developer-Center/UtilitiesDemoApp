...
public class WatsonJavaResource {
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource/greet/{name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/WatsonJava/resource/protected"
	 */
